...
func runConnHandler(t *testing.T, identity tamizdat.ConnIdentity, destination string) *Request {
	...
	in := &SamizdatInbound{tag: "tamizdat-in"}
...
// TestSamizdatConnHandlerEmptyUserWhenNoRegistry covers the embedded /
...
func TestSamizdatConnHandlerEmptyUserWhenNoRegistry(t *testing.T) {
	identity := tamizdat.ConnIdentity{
